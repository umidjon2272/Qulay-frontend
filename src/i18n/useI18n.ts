...
export const RU: Record<string, string> = {
  ...
  'ai.stopResponse': 'Остановить ответ', 'ai.incomplete': 'Ответ остановлен · не завершён',
  'settings.chimeDescription': 'Мягкий оригинальный сигнал из двух нот', 'settings.chimePreview': 'Прослушать сигнал',
  'settings.chimeError': 'Не удалось включить звук. Проверьте настройки браузера и устройства.', 'settings.volume': 'Громкость',
  'settings.chimeHelp': 'Работает при открытом сайте. Нажмите на страницу, чтобы разрешить звук. Тихие часы определяются по времени устройства.',
  'integrations.loginMethod': 'Способ подключения Telegram', 'integrations.byPhone': 'По телефону', 'integrations.byQr': 'По QR-коду',
  'integrations.loginCode': 'Код Telegram', 'integrations.tryQr': 'Если код не приходит, попробуйте подключиться по QR-коду.',
  'integrations.twoFactor': 'Пароль 2FA', 'integrations.finish': 'Завершить подключение',
  'integrations.qrInstructions': 'В Telegram откройте Настройки → Устройства → Подключить устройство и отсканируйте QR-код.',
  'integrations.qrAlt': 'QR-код входа в Telegram', 'integrations.openTelegram': 'Открыть в Telegram', 'integrations.refreshQr': 'Обновить QR-код',
  'integrations.phoneNumber': 'Номер телефона', 'integrations.checking': 'Проверяем…', 'integrations.sendCode': 'Отправить код', 'integrations.verifyCode': 'Подтвердить код',
  'integrations.qrPreparing': 'Создаём QR-код…', 'integrations.qrLoading': 'Загружаем QR-код…', 'integrations.qrRefreshing': 'Обновляем QR-код…',
  'integrations.qrExpires': 'Обновится через {seconds} с', 'integrations.disconnecting': 'Отключаем…', 'integrations.disconnectAction': 'Отключить',
  "memory.exportError": "Не удалось экспортировать память",
  "settings.languageSaveError": "Не удалось сохранить язык",
  "files.saved": "Изменения сохранены", "files.updateError": "Не удалось изменить файл",
  "files.move": "Переместить", "files.fileName": "Имя файла", "files.root": "Все файлы (корень)",
  "common.previous": "Назад", "common.next": "Далее", "settings.aiSaveError": "Не удалось сохранить настройки AI",
  ...
  "billing.subscriptionRequiredEyebrow": "ТРЕБУЕТСЯ ПОДПИСКА", "billing.subscriptionRequiredTitle": "Активируйте тариф", "billing.subscriptionRequiredText": "Для продолжения выберите и активируйте подходящий тариф.", "billing.viewPlans": "Посмотреть тарифы",
  ...
  "admin.connection.connected": "Подключено", "admin.connection.disconnected": "Не подключено", "admin.connection.degraded": "Ограничено", "admin.connection.authorizing": "Подключение", "admin.connection.error": "Ошибка",
  ...
  "admin.noActivityYet": "Активности пока нет", "admin.neverLoggedIn": "Ещё не входил", "admin.noActivity": "Активность отсутствует", "admin.lastLogin": "Последний вход", "admin.comingSoon": "Скоро", "admin.notChecked": "Не проверено",
  ...
  "settings.integrations.subtitle": "Telegram, Google Calendar, Google Drive и Bito.", "settings.connectedCount": "{count} подключено",
