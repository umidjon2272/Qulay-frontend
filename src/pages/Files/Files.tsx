...
const Files = () => {
  ...
  return <main className="files-page">
    ...
    <section className="files-ai"><div className="files-ai__icon"><Star size={19} /></div><div><span>QULAY AI</span><h2>Fayllaringiz bilan aqlliroq ishlang</h2><p>Fayllarni toping, oching va AI bilan ishlashga tayyorlang.</p></div><button type="button" onClick={openAIChat}>Qulay AI<ArrowUpRight size={14} /></button></section>
