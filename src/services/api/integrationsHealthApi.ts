...
export type IntegrationsHealth = { google: IntegrationHealth; telegram: IntegrationHealth; bito: IntegrationHealth; whatsapp: IntegrationHealth; instagram: IntegrationHealth };
